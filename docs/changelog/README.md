...
| Version | Highlights |
|---|---|
| [0.4.4](0.4.4.md) | Unreleased — fixes regressions surfaced while re-verifying 0.4.3's fixes (cache-invalidation key mismatch, `@LookupIndex` + clustering key so far) |
